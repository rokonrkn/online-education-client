            ...
            <div className="flex h-screen items-center justify-center bg-[#8EA7E9]/20 p-6 md:p-0">
                <div className="flex h-full w-full overflow-hidden rounded-xl shadow-md  md:h-[90%] md:w-[80%] lg:h-[80%]">
                    ...
                    <div className="flex w-full flex-col justify-center bg-white py-10 lg:w-[60%]">
                        ...
                        <form onSubmit={handleRegistration} className="flex  w-full flex-col items-center justify-center gap-4">
                            ...
                            <Link to={`/login`}><p className="text-[14px] text-gray-400">You have an account ? <a className="text-[#8EA7E9] ">Then login</a></p></Link>
